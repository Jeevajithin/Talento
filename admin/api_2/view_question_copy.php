...
//$query = "SELECT * FROM online_test where exam_id='$exam_id' or exam_id=$exam_id1"; 



//$query = "SELECT * FROM `online_test` where exam_id=123 or exam_id in (SELECT * FROM `online_test` where batch_id=5 ORDER BY test_id limit 45)";
